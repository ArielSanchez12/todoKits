    ...
    return (
        <div className='md:flex md:min-h-screen'>
            ...
            <div className='md:w-1/6 bg-black px-8 py-6'>
                ...
                <p className='text-white text-center my-4 text-base'> <span className='bg-green-500 w-3 h-3 inline-block rounded-full'></span> Bienvenido - {user?.nombre}, {user?.apellido} || {user?.nombrePropietario}</p>
            ...
            <div className='flex-1 flex flex-col justify-between h-screen bg-white'>
                <div className='bg-black py-3 flex md:justify-end items-center gap-5 justify-center'>
                    <div className='text-md font-semibold text-slate-100'>
                        Usuario - {user?.nombre} {user?.apellido} || {user?.nombrePropietario}
