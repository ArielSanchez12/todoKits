...
import { cardPasswordDocenteSchema } from "../../schemas/cardPasswordDocenteSchema";

const CardPasswordDocente = () => {
    const { register, handleSubmit, formState: { errors }, reset } = useForm({
        resolver: zodResolver(cardPasswordDocenteSchema)
    });
    ...
    const updatePassword = (data) => {
        updatePasswordProfile(data, userData._id)
            .then((response) => {
                if (response?.msg) {
                ...
                <div className="mb-3 relative">
                    ...
                    <div className="relative">
                        <input
                            ...
                            className="block w-full rounded-md border border-gray-300 focus:border-purple-700 focus:outline-none focus:ring-1 focus:ring-purple-700 py-1 px-1.5 text-gray-500 pr-10"
                            {...register("confirmPasswordDocente")}
                        />
                        <button
                            type="button"
                    ...
                    {errors.confirmPasswordDocente && <p className="text-red-800">{errors.confirmPasswordDocente.message}</p>}
                </div>
...
export default CardPasswordDocente