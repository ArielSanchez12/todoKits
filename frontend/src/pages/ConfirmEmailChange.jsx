...
const ConfirmEmailChange = () => {
    ...
    const verifyToken = async () => {
        try {
            const url = `${import.meta.env.VITE_BACKEND_URL}/administrador/confirm-new-email/${token}`
    ...
    return (
        <div className="h-screen flex flex-col items-center justify-center bg-white">
            ...
            <img
                ...
                src={logobuhoPuente}
                alt="Cambio de email exitoso"
            />

            {/* Mensajes y botón */}
            <div className="mt-8 text-center px-4">
                <p className="text-3xl md:text-4xl lg:text-5xl text-black">Cambio de Email Exitoso</p>
                <p className="md:text-lg lg:text-xl text-black mt-4">Ya puedes iniciar sesión con tu nuevo correo</p>
                <Link
                    to="/login"
