...
const Dashboard = () => {
    ...
    // Puedes agregar una verificación simple:
    if (!user) {
        return (
        ...
        <div className='md:flex md:min-h-screen'>
            ...
            <div className='md:w-1/6 bg-black px-8 py-6'>
                ...
                <img
                    ...
                    alt="img-client"
                    className="m-auto mt-8 p-1 border-2 border-slate-500 rounded-full h-28 w-28 object-cover"
                />
                ...
                <div className='bg-black py-3 flex md:justify-end items-center gap-5 justify-center'>
                    ...
                    <div>
                        <img
                            ...
                            alt="img-client"
                            className="border-2 border-green-500 rounded-full h-12 w-12 object-cover"
                        />
                    </div>
                    <div>
